...
:::note
Option 1 requires the `[backdrop]` section to be enabled in your Noctalia configuration. See [Wallpaper and backdrop](/v5/desktop/wallpaper/) for the relevant options.
:::
...
:::note
Option 2 should be used with the `[backdrop]` section disabled in your Noctalia configuration.
:::
...
Adjust the blur parameters above alongside Noctalia's transparency settings (panel background opacity, bar background opacity, translucent widgets) to achieve your desired look.
:::
